...
#ifdef RIL_FIVE_SEARCH_RESPONSES
            sCount++;
            // ignore the fifth string that is returned by newer MOTO libmoto_ril.so.
...
static int responseRilSignalStrength(Parcel &p,
    ...
    if (responselen >= sizeof (RIL_SignalStrength_MOTO)) {
        RIL_SignalStrength_MOTO *p_cur = ((RIL_SignalStrength_MOTO *) response);
...
#endif
{
    ...
    if ((unsolResponseIndex < 0)
        ...
        /*
         * catching MOTO custom responses and mapping them directly to the ril_unsol_commands array
        ...
        switch (unsolResponse) {
          case RIL_UNSOL_ENTER_LPM: unsolResponseIndex = moto_base + 0; break;
          case RIL_UNSOL_CDMA_3G_INDICATOR: unsolResponseIndex = moto_base + 1; break;
          case RIL_UNSOL_CDMA_ENHANCE_ROAMING_INDICATOR: unsolResponseIndex = moto_base + 2; break;
          case RIL_UNSOL_CDMA_NETWORK_BASE_PLUSCODE_DIAL: unsolResponseIndex = moto_base + 3; break;
          case RIL_UNSOL_RESPONSE_PHONE_MODE_CHANGE: unsolResponseIndex = moto_base + 4; break;
          case RIL_UNSOL_RESPONSE_VOICE_RADIO_TECH_CHANGED: unsolResponseIndex = moto_base + 5; break;
          case RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED_MOTO: unsolResponseIndex = moto_base + 6; break;
          case RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED_M7:
          case RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED: unsolResponseIndex = moto_base + 7; break;
...
*/
    switch(request) {
        ...
        case RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED_MOTO: return "UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED";
        case RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED_M7:
